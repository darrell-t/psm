<?php
    ...
    if(!empty($_POST['airTemp']) && !empty($_POST['airHum']) && !empty($_POST['waterTemp']) && !empty($_POST['lightInt'])) {
        ...
        if ($conn->query($sqlAirTemp) === TRUE && $conn->query($sqlAirHum) === TRUE && $conn->query($sqlWaterTemp) === TRUE && $conn->query($sqlLightInt) === TRUE) {
        	echo "OK";
        } else {
